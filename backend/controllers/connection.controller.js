...
export const sendConnectionRequest = async (req, res) => {
  try {
    ...
    console.error(
      `Error in sendConnectionRequest controller: ${error.message}`
    );
...
export const acceptConnectionRequest = async (req, res) => {
  try {
    ...
    // if I'm your friend then you're also my friend
    ...
    try {
      ...
      console.error(
        `Error in sendConnectionAcceptedEmail controller: ${error.message}`
      );
    }
  } catch (error) {
    console.error(
      `Error in acceptConnectionRequest controller: ${error.message}`
    );
    res.status(500).json({ message: "Internal server error" });
  }
};
...
export const rejectConnectionRequest = async (req, res) => {
  try {
    ...
    console.error(
      `Error in rejectConnectionRequest controller: ${error.message}`
    );
    res.status(500).json({ message: "Internal server error" });
  }
};
...
export const getConnectionRequests = async (req, res) => {
  try {
    ...
    console.error(
      `Error in getConnectionRequests controller: ${error.message}`
    );
    res.status(500).json({ message: "Internal server error" });
  }
};
